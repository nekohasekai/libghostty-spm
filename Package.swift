...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/nekohasekai/libghostty-spm/releases/download/storage.1.1.21/GhosttyKit.xcframework.zip",
            checksum: "ce2cd38b1fe2771afa8b87dbc7dfab8f57da2a0a04ec10729e932e0a472b507e"
        ),
        .testTarget(
            name: "GhosttyKitTest",
