...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/nekohasekai/libghostty-spm/releases/download/storage.1.1.11/GhosttyKit.xcframework.zip",
            checksum: "b9e791cb3792008d6e7e994056938b0cee90af98ce877fcbd1d51ffa0643f5c3"
        ),
        .testTarget(
            name: "GhosttyKitTest",
