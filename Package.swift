...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/nekohasekai/libghostty-spm/releases/download/storage.1.1.17/GhosttyKit.xcframework.zip",
            checksum: "8ef17259689354efc21425d438d202e63da2983add34b5b70e17a13262665849"
        ),
        .testTarget(
            name: "GhosttyKitTest",
