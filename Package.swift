...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/nekohasekai/libghostty-spm/releases/download/storage.1.1.16/GhosttyKit.xcframework.zip",
            checksum: "fb41e04f5b16fe21a0244e64b88a8f3d946935bc143ac4fa0ba253da71e1ec90"
        ),
        .testTarget(
            name: "GhosttyKitTest",
