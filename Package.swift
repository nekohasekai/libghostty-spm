...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/nekohasekai/libghostty-spm/releases/download/storage.1.1.20/GhosttyKit.xcframework.zip",
            checksum: "5fc4932a6e26810e0a6ae2f8cee276cdba4103cf4dfd7fc47ad281dea38cbed9"
        ),
        .testTarget(
            name: "GhosttyKitTest",
