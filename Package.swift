...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/nekohasekai/libghostty-spm/releases/download/storage.1.1.10/GhosttyKit.xcframework.zip",
            checksum: "e97430b27ce81f39c17cf9b8b870c510c9cfa4028aff86c0e32d08c73586e147"
        ),
        .testTarget(
            name: "GhosttyKitTest",
