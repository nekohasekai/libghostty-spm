...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/nekohasekai/libghostty-spm/releases/download/storage.1.1.14/GhosttyKit.xcframework.zip",
            checksum: "b988f5105a84550963ab737fb8d7f00a3a6d51edf6fa736af3850bec90304e1c"
        ),
        .testTarget(
            name: "GhosttyKitTest",
