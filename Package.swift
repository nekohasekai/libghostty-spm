...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/Lakr233/libghostty-spm/releases/download/storage.1.1.10/GhosttyKit.xcframework.zip",
            checksum: "3c11eda5101690afbad92ab95fdcb5c9dfc265ab375538db30bea665fbd354b2"
        ),
        .testTarget(
            name: "GhosttyKitTest",
