...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/nekohasekai/libghostty-spm/releases/download/storage.1.1.19/GhosttyKit.xcframework.zip",
            checksum: "bf82011e41453233f825e2a5ac4148c04fc0bc4c74fd6a0311eb25f9858d6b66"
        ),
        .testTarget(
            name: "GhosttyKitTest",
