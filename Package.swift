...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/nekohasekai/libghostty-spm/releases/download/storage.1.1.13/GhosttyKit.xcframework.zip",
            checksum: "46c4c1ce75fbb39a6ce6c06f85a8fcc5862d9bbb1b8b66cf5069ae6267bb5579"
        ),
        .testTarget(
            name: "GhosttyKitTest",
